...
describe("SignUpForm", () => {
  ...
  it("should change the name state of login component", () => {
    wrapper
      .find("#uname")
      .simulate("change", { target: { name: "uname", value: "Alex" } });
  ...
  it("should change the dob state of login component", () => {
    wrapper
      .find("#dob")
      .simulate("change", { target: { name: "dob", value: "26/5/1996" } });
    expect(wrapper.state("dob")).toEqual("26/5/1996");
  });
  it("should change the mobileno state of login component", () => {
    wrapper.find("#mobileno").simulate("change", {
      target: { name: "mobileno", value: "8789879878" },
    });
