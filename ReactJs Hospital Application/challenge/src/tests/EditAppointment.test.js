...
describe("testing EditAppointment", () => {
  ...
  beforeEach(
    () =>
      (wrapper = shallow(<EditAppointment match={{ params: { appId: 1 } }} />))
  );
  ...
  it("renders a name input", () => {
    expect(
      shallow(<EditAppointment match={{ params: { appId: 1 } }} />).find(
        "#name"
      ).length
    ).toEqual(1);
  });
